...
def parse_args():
    ...
    parser.add_argument("--good-policy", type=str, default="pmaddpg", help="policy for good agents")
    parser.add_argument("--adv-policy", type=str, default="pmaddpg", help="policy of adversaries")
    ...
    parser.add_argument("--gda-step", type=int, default=20, help="number of steps to do gradient descent ascent algorithm.")
    # Checkpointing
